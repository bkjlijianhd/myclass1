...
*/
var mongoose = require("mongoose");
mongoose.connect('mongodb://bkj:3211014@127.0.0.1:27017/login?authSource=admin', {useMongoClient: true});
...
*/
var RedisClient = redis.createClient({host:"127.0.0.1", port: 6379, password: '3211014'});
